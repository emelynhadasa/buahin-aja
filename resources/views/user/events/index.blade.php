            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.createGame').forEach(button => {
                    button.addEventListener('click', event => {
                        ...
                        if (gameType.toLowerCase() == 'quiz'){
                            window.location.href = "{{ route('user.quiz-events', ':eventId') }}".replace(':eventId', eventId);
                        }
                    });
                });
                ...
                document.querySelectorAll('.showDetail').forEach(button => {
                    button.addEventListener('click', event => {
                        ...
                        window.location.href = "{{ route('user.events.show', ':eventId') }}".replace(':eventId', eventId);
                    });
                });
            });
        </script>

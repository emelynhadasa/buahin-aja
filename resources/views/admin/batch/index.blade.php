            ...
            <div class="container mx-auto py-6 flex flex-wrap">
                <div class="w-full md:w-3/4 px-4">
                    <form action="#" method="GET" class="mb-4">
                        @csrf
                        <input type="text" id="search" placeholder="Search batch..." class="px-4 py-2 border rounded">
                    </form>
                    <table class="batch-table min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-center">
                            @foreach ($batches as $batch)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $batch->id }}</td>
                ...
                <div class="w-full md:w-1/4 px-4">
                    <form action="{{ route('admin.batches.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        @csrf
                        <div class="mb-4">

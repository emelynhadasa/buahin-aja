<x-app-layout>
    <div class="max-w-3xl mx-auto pt-7">
        <form action="{{ route('admin.majors.update', $major) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Name</label>
                    <input value="{{ $major->name }}" type="text" id="name" name="name"

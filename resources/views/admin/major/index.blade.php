        ...
        <x-app-layout>
            <div class="container mx-auto py-6 flex flex-wrap">
                <div class="w-full md:w-3/4 px-4">
                    <form action="#" method="GET" class="mb-4">
                        @csrf
                        <input type="text" id="search" placeholder="Search major..." class="px-4 py-2 border rounded">
                    </form>
                    <table class="major-table min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <button
                                            ...
                                            <a href="{{ route('admin.majors.delete', $major) }}">Delete</a>
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="w-full md:w-1/4 px-4">
                    <form action="{{ route('admin.majors.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        @csrf
                        <div class="mb-4">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const tableRows = document.querySelectorAll('.major-table tbody tr');

        ...
        <x-app-layout>
            <div class="container mx-auto py-6 flex flex-wrap">
                <div class="w-full md:w-3/4 px-4">
                    <form action="#" method="GET" class="mb-4">
                        @csrf
                        <input type="text" id="search" placeholder="Search type..." class="px-4 py-2 border rounded">
                    </form>
                    <table class="type-table min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <button
                                            ...
                                            <a href="{{ route('admin.types.delete', $type) }}">Delete</a>
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const tableRows = document.querySelectorAll('.type-table tbody tr');
